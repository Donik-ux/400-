  ...
  return (
    <div className="flex flex-col gap-6 max-w-2xl">
      ...
      <div className="night-panel rounded-2xl p-6">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input type="color" value={form.primaryColor} onChange={e => f('primaryColor', e.target.value)}
                className="w-12 h-10 rounded-xl night-inset cursor-pointer p-1" />
        ...
        {/* Maintenance Mode */}
        <div className="mt-4 flex items-center justify-between p-4 rounded-xl night-inset">
          <div className="flex items-center gap-3">
            <AlertTriangle className="w-4 h-4 text-warn-n" />
            <div>
          ...
          <button
            ...
            className={`relative w-11 h-6 rounded-full transition-all duration-300 ${form.maintenanceMode ? 'bg-[#00a58e]' : 'bg-[#8fb4ff]/15'}`}
          >
      ...
      <div className="flex items-center gap-3">
        <button onClick={handleSave}
          className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-[11px] font-black uppercase tracking-widest transition-all ${saved ? 'bg-[#86d29a] text-[#14181d]' : 'bg-gradient-to-r from-[#61d1bf] to-[#009882] text-[#14181d] hover:brightness-110 shadow-soft'}`}>
