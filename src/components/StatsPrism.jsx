        ...
        >
          {faces.map((f, i) => (
            ...
            >
              ...
              <div className="absolute -right-8 -bottom-8 w-28 h-28 rounded-full bg-[#febb02]/10 blur-2xl pointer-events-none" />

              <div className="relative h-full flex items-center">
                {/* Stat half */}
                <div className="flex-1 min-w-0 flex items-center justify-center gap-3 md:gap-4 px-3 md:px-8">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-[#f5b942]/12 text-[#ffd76e] flex items-center justify-center shrink-0 ring-1 ring-[#f5b942]/25">
                ...
                {/* Divider */}
                <div className="self-stretch my-5 w-px bg-gradient-to-b from-transparent via-[#f5b942]/40 to-transparent shrink-0" />
      ...
      <div className="flex items-center justify-center gap-1.5 mt-3">
        {faces.map((_, i) => (
          <button
            ...
            className={`h-1.5 rounded-full transition-all ${i === active ? 'w-5 bg-[#f5b942]' : 'w-1.5 bg-[#d9c9a3] hover:bg-[#b8a888]'}`}
          />
        ))}
      </div>
    </div>
