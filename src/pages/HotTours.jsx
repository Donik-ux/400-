                        ...
                        <button key={n} type="button" onClick={() => sync.onChangeDays(n)}
                          className={`py-3 rounded-xl text-[14px] font-black transition active:scale-95 ${
                            Number(days) === n
                              ...
                              : 'bg-[#f6f1e4] border border-[#e6dcc3] text-[#1a1a1a] hover:border-[#0071c2] hover:bg-[#f0f5ff]'
                          }`}>
      ...
      <section id="ai-packages-grid" className="max-w-7xl mx-auto px-4 md:px-8 py-10 scroll-mt-6">
        <div className="flex items-end justify-between mb-5 flex-wrap gap-3">
          ...
          <button onClick={regenerate} disabled={loading}
            className="px-4 py-2.5 rounded-xl border-2 border-[#e6dcc3] hover:border-[#0071c2] hover:bg-[#f0f5ff] text-[13px] font-black text-[#1a1a1a] flex items-center gap-2 transition disabled:opacity-50">
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    ...
                    <div className="bg-[#f6f1e4] border border-[#efe6d2] rounded-xl p-2.5 mb-3">
                      <div className="text-[9.5px] font-black uppercase tracking-widest text-[#93876f] mb-1.5 flex items-center gap-1">
                        <Wallet className="w-3 h-3 text-[#0071c2]" /> {t('hotTours.grid.whereGoes1')} {fmt(p.price)} {t('hotTours.grid.whereGoes2')}
                      </div>
...
const Field = ({ icon, label, children }) => (
  <label className="block bg-[#f6f1e4] border border-[#e6dcc3] rounded-xl px-3.5 py-2.5 focus-within:border-[#0071c2] focus-within:ring-4 focus-within:ring-[#0071c2]/10 transition">
        ...
        <div className="p-5 md:p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-2 pt-3 border-t border-[#efe6d2]">
            <button onClick={onClose}
              className="flex-1 py-3 rounded-xl border-2 border-[#e6dcc3] hover:border-[#0071c2] text-[13px] font-black text-[#1a1a1a] transition active:scale-95">
