...
export default function TripPlan() {
    ...
    return (
      <div className="min-h-screen bg-[#faf6ed] flex items-center justify-center p-6">
        <div className="bg-white rounded-3xl border border-[#e6dcc3] p-10 max-w-md w-full text-center shadow-float relative overflow-hidden">
          <div className="absolute -top-20 -right-20 w-64 h-64 rounded-full bg-[#d9a43e]/15 blur-3xl pointer-events-none animate-float" />
          <div className="relative">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#d9a43e] to-[#c08c33] flex items-center justify-center mx-auto mb-4 rotate-3 shadow-lift">
  ...
  return (
    <div className="min-h-screen bg-[#faf6ed]">
      ...
      {/* ── HEADER ────────────────────────────────────────────── */}
      <section className="relative bg-gradient-to-br from-[#002250] via-[#003580] to-[#2f6395] text-white overflow-hidden">
        <div className="absolute -top-20 -right-12 w-64 h-64 rounded-full bg-[#d9a43e]/15 blur-3xl pointer-events-none animate-float" />
        <div className="relative max-w-6xl mx-auto px-4 md:px-8 py-7">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#d9a43e] text-[#1a1a1a] text-[10px] font-black uppercase tracking-widest mb-2.5 shadow-float">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-8 page-fade">
        ...
        {plan && isGuest && !guestBannerDismissed && (
          <div className="mb-6 flex items-start gap-3 rounded-2xl border border-[#cf9c3f]/50 bg-[#fff7e6] p-4 shadow-soft">
            <div className="w-9 h-9 rounded-xl bg-[#d9a43e] flex items-center justify-center text-[#1a1a1a] shrink-0">
            ...
            <div className="min-w-0 flex-1">
              ...
              <button
                ...
                className="mt-2.5 inline-flex items-center gap-1.5 bg-[#003580] hover:bg-[#2f6395] text-white text-[12px] font-black rounded-lg px-3.5 py-2 shadow-soft transition active:scale-95">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-5" id="print-plan">
            ...
            {plan?.cityInfo?.upcomingEvent && (
              <div className="flex items-start gap-3 rounded-2xl border border-[#cf9c3f]/50 bg-gradient-to-r from-[#fff7e6] to-[#fffdf5] p-4 shadow-soft">
                <div className="w-10 h-10 rounded-xl bg-[#d9a43e] flex items-center justify-center text-[#1a1a1a] shrink-0">
            ...
            <div className="bg-white border border-[#e6dcc3] rounded-2xl p-5 md:p-6 shadow-soft">
              <div className="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest text-[#2f6395] mb-1.5">
              ...
              <div className="relative h-56 md:h-72 rounded-2xl overflow-hidden shadow-float">
                ...
                <div className="absolute bottom-4 left-5 right-5 text-white">
                  <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-white/80 mb-1">
                    <MapPin className="w-3 h-3 text-[#d9a43e]" /> {item.destination}
                  </div>
                  ...
                  <div className="flex items-center gap-3 mt-2 text-[12px] font-bold">
                    {item.rating && <span className="flex items-center gap-1"><Star className="w-3.5 h-3.5 fill-[#d9a43e] text-[#d9a43e]" /> {item.rating}</span>}
            ...
            {plan?.cityInfo && (plan.cityInfo.about || plan.cityInfo.currentHappenings) && (
              <div className="bg-white border border-[#e6dcc3] rounded-2xl p-5 shadow-soft">
                <div className="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest text-[#2f6395] mb-2.5">
                ...
                {plan.cityInfo.currentHappenings && (
                  <div className="mt-3 flex items-start gap-2 bg-[#f0f5ff] rounded-xl p-3">
                    <Clock className="w-4 h-4 text-[#2f6395] mt-0.5 shrink-0" />
            ...
            {(() => {
              ...
              return (
                <div className="bg-white border border-[#e6dcc3] rounded-2xl p-4 shadow-soft">
                  <div className="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest text-[#2f6395] mb-3 px-1">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 flex-wrap mb-0.5">
                        <span className="text-[10px] font-black uppercase tracking-widest text-[#2f6395]">{t('tripPlan.yourStay')}</span>
                        {h.recommended && (
                      ...
                      {h.address && (
                        <a href={url || '#'} target="_blank" rel="noreferrer noopener"
                          className="mt-1 inline-flex items-start gap-1 text-[12px] text-[#2f6395] hover:underline font-semibold">
                          <MapPin className="w-3 h-3 mt-0.5 text-[#d9a43e]" /> {h.address}{h.area ? ` · ${h.area}` : ''}
                    ...
                    {url && (
                      <a href={url} target="_blank" rel="noreferrer noopener"
                        className="px-3 py-2 rounded-lg bg-[#d9a43e] hover:bg-[#c08c33] text-[#1a1a1a] text-[11px] font-black flex items-center gap-1 active:scale-95 transition shrink-0">
            ...
            <div className="bg-white border border-[#e6dcc3] rounded-2xl p-5 shadow-soft">
              <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-[#93876f] mb-3">
                <Wallet className="w-3.5 h-3.5 text-[#2f6395]" /> {fill(t('tripPlan.whereMoneyGoes'), { total: totalNice })}
              </div>
                  ...
                  return (
                    <div key={i} className="group bg-gradient-to-b from-white to-[#f6f1e4] border border-[#efe6d2] rounded-xl p-3 text-center transition-all hover:border-[#cfe2f7] hover:shadow-soft">
                      <div className="w-8 h-8 rounded-lg bg-[#f0f5ff] flex items-center justify-center mx-auto mb-1.5 transition-colors group-hover:bg-[#dceaff]">
                        <s.icon className="w-4 h-4 text-[#2f6395]" />
                      </div>
            ...
            <div className="bg-white border border-[#e6dcc3] rounded-2xl p-5 shadow-soft">
              <div className="flex items-center justify-between mb-3">
                ...
                {plan?.source && (
                  <span className="text-[10px] font-black uppercase tracking-widest text-[#2f6395] bg-[#f0f5ff] px-2 py-1 rounded-md">
              ...
              {!loading && plan?.days?.length > 0 && (() => {
                ...
                <div className="space-y-3">
                  ...
                  <div className="rounded-xl border border-[#e6dcc3] bg-gradient-to-br from-white to-[#f6f1e4] px-4 py-3.5 flex items-center gap-3 flex-wrap shadow-soft">
                    <Wallet className="w-4 h-4 text-[#2f6395] shrink-0" />
                    ...
                    <div className="flex-1 min-w-32">
                      <div className="h-2.5 bg-[#efe6d2] rounded-full overflow-hidden">
                        <div
                          className={`h-full rounded-full transition-all duration-700 ${totalDayCosts > Number(item.price) ? 'bg-[#b3402e]' : 'bg-gradient-to-r from-[#d9a43e] to-[#cf9c3f]'}`}
                  ...
                  {plan.days.map((d, dayIdx) => {
                    ...
                    <motion.div key={d.day} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2 }}
                      ...
                      <span className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-[#2f6395] to-[#003580]" />
                      <div className="px-4 py-3 pl-5 bg-white border-b border-[#efe6d2] flex items-center gap-3 flex-wrap">
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#003580] to-[#2f6395] text-white text-[13px] font-black flex items-center justify-center shrink-0 shadow-soft">D{d.day}</div>
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2 flex-wrap">
                            <span className="text-[10px] font-black uppercase tracking-widest text-[#2f6395]">{fill(t('tripPlan.dayLabel'), { day: d.day })}</span>
                        ...
                        {dayMap && (
                          <a href={dayMap} target="_blank" rel="noreferrer noopener"
                            className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-md bg-[#f0f5ff] hover:bg-[#dceaff] text-[#2f6395] text-[11px] font-black transition"
                          ...
                          {d.events.map((ev, j) => {
                            ...
                            <li key={j} className="relative">
                              <div className="px-4 py-3 flex items-start gap-3">
                                <div className="w-14 shrink-0 text-[#2f6395] font-black text-[13px] tabular-nums pt-0.5">
                                  {ev.time || '—'}
                                </div>
                                <div className="min-w-0 flex-1">
                                  <div className="flex items-start justify-between gap-2 mb-1">
                                    <div className="text-[14px] font-black text-[#1a1a1a] leading-snug">{ev.name}</div>
                                    {ev.type && <span className="px-1.5 py-0.5 rounded bg-[#f0f5ff] text-[#2f6395] text-[9.5px] font-black uppercase tracking-wider whitespace-nowrap">{ev.type}</span>}
                                  </div>

                                  {ev.address && (
                                    <a href={mapUrl || '#'} target="_blank" rel="noreferrer noopener"
                                      className="flex items-start gap-1.5 text-[12px] text-[#1a1a1a] font-semibold hover:text-[#2f6395] leading-snug break-words group/loc"
                                      title="Open in Google Maps">
                                      <MapPin className="w-3.5 h-3.5 mt-0.5 shrink-0 text-[#d9a43e]" />
                                      <span className="break-words">
                                        <span className="text-[#93876f] font-black uppercase tracking-wider text-[10px] mr-1">{t('tripPlan.location')}</span>
                                        <span className="text-[#2f6395] group-hover/loc:underline">{ev.address}</span>
                              ...
                              {!isLast && ev.transportToNext && (
                                <div className="ml-12 pl-3 pr-4 py-1.5 border-l-2 border-dashed border-[#dceaff] flex items-center gap-2 text-[11px] text-[#5c5245] font-semibold">
                                  <Navigation className="w-3 h-3 text-[#2f6395] shrink-0" />
                      ...
                      <div className="px-4 py-2.5 bg-white border-t border-[#e6dcc3] flex items-center justify-between flex-wrap gap-2">
                        <div className="text-[11px] font-black uppercase tracking-widest text-[#93876f] flex items-center gap-1.5">
                          <Wallet className="w-3.5 h-3.5 text-[#2f6395]" /> {t('tripPlan.spentToday')}
                        </div>
                ...
                <div className="grid sm:grid-cols-2 gap-2.5">
                  {(plan.emergency.numbers || []).map((n, i) => (
                    <a key={i} href={`tel:${String(n.number).replace(/\s/g, '')}`}
                      className="flex items-center gap-3 p-3 rounded-xl bg-[#f6f1e4] border border-[#e6dcc3] hover:border-[#2f6395] hover:bg-[#f0f5ff] transition group">
                      ...
                      <Phone className="w-4 h-4 text-[#93876f] group-hover:text-[#2f6395] transition" />
                    </a>
                  ))}
                </div>
            ...
            {plan?.travelTips?.length > 0 && (
              <div className="bg-white border border-[#e6dcc3] rounded-2xl p-5 shadow-soft">
                <div className="flex items-center gap-2 mb-3">
                  <Lightbulb className="w-4 h-4 text-[#d9a43e]" />
          ...
          <div className="lg:col-span-1">
            <div className="bg-white border border-[#e6dcc3] rounded-2xl overflow-hidden sticky top-[80px] shadow-float no-print">
              ...
              <div className="relative bg-gradient-to-br from-[#002250] to-[#2f6395] text-white px-5 py-5 overflow-hidden">
                <div className="absolute -top-12 -right-8 w-40 h-40 rounded-full bg-[#d9a43e]/15 blur-2xl pointer-events-none" />
                <div className="relative">
              ...
              <div className="p-5 space-y-3">
                ...
                <Field label={t('tripPlan.travelers')} icon={<Users className="w-3.5 h-3.5" />}>
                  <div className="flex items-center gap-2">
                    <button type="button" onClick={() => setTravelers(t => Math.max(1, t - 1))}
                      className="w-7 h-7 rounded-md bg-[#f0f5ff] text-[#2f6395] text-[16px] font-black hover:bg-[#dceaff] active:scale-95 transition">−</button>
                ...
                <div className="grid grid-cols-2 gap-2 pt-1">
                  ...
                  <button onClick={handleShare}
                    className="px-3 py-3 rounded-xl border-2 border-[#2f6395] text-[#2f6395] text-[12px] font-black hover:bg-[#f0f5ff] transition active:scale-95 flex items-center justify-center gap-1.5">
                    <Share2 className="w-4 h-4" /> {t('tripPlan.share')}
                  </button>
                  <button onClick={handlePrint}
                    className="px-3 py-3 rounded-xl border-2 border-[#e6dcc3] text-[#1a1a1a] text-[12px] font-black hover:border-[#2f6395] hover:bg-[#f0f5ff] transition active:scale-95 flex items-center justify-center gap-1.5">
                ...
                <button onClick={runGenerate} disabled={loading}
                  className="w-full py-2.5 rounded-xl bg-[#f0f5ff] hover:bg-[#dceaff] text-[#2f6395] text-[12px] font-black transition active:scale-95 flex items-center justify-center gap-1.5 disabled:opacity-50">
...
const Field = ({ icon, label, children }) => (
  <label className="block bg-white border border-[#e6dcc3] rounded-xl px-3 py-2 focus-within:border-[#2f6395] focus-within:ring-4 focus-within:ring-[#2f6395]/10 transition">
...
function buildPdfHtml({ item, plan, travelers, travelDate, name }) {
  ...
  <style>
    *{box-sizing:border-box} body{font-family:Arial,Helvetica,sans-serif;color:#1a1a1a;padding:32px;max-width:820px;margin:auto;}
    ...
    .muted{color:#5c5245;font-size:12px} .badge{background:#d9a43e;color:#1a1a1a;padding:3px 8px;border-radius:6px;font-size:10px;font-weight:bold;letter-spacing:1px;text-transform:uppercase;display:inline-block;margin-right:6px}
    ...
    .next{color:#2f6395;font-size:11px;font-style:italic}
    ...
    .hotel{background:#fff7e6;border:1px solid #e6c988;padding:10px 12px;border-radius:8px;font-size:13px;margin:6px 0 16px}
