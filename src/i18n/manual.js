...
export default {
  ...
  ru: {
    ...
    homePage: {
      ...
      wish: {
        eyebrow: 'Просто опишите поездку — ИИ сам заполнит поиск',
        tryLabel: 'Попробуйте:',
        ex1: 'Бухара на 5 дней в мае, $900',
        ex2: 'Дубай на неделю за $2500 в июне',
        ex3: 'Мальдивы в сентябре, 10 дней, люкс',
        ex4: 'Выходные в Стамбуле до $800',
      },
      radar: {
        eyebrow: 'Радар путешествий',
        heading: 'Куда поехать в {month}',
        subtitle: 'Подборка под сезон этого месяца — с учётом вашего вишлиста.',
        reasonPeak: 'Пик сезона',
        reasonShoulder: 'Хороший сезон',
        reasonWishlist: 'Из вашего вишлиста',
        cta: 'AI-план',
      },
      antarctica: {
        eyebrow: '7-й континент · Экспедиции 2026–2027',
        title1: 'В этом году ступите на',
        title2: 'Антарктиду',
        sub: 'За год Антарктиду посещает меньше людей, чем поднимается в базовый лагерь Эвереста. Колонии пингвинов, айсберги размером с собор, пролив Дрейка — а наш ИИ спланирует всю экспедицию под ваш бюджет.',
        statContinent: 'Последний континент',
        statSeason: 'Сезон: ноя – март',
        statFrom: 'Экспедиции от',
        cta: 'Открыть экспедицию',
      },
    },
    homeStats: {
      ai: 'Работает на ИИ',
    ...
    hotTours: {
      toasts: {
        building: 'Строим подробный план',
        aiBuilt: 'ИИ собрал 4 тура под ваш баланс',
        smartMatch: 'Smart Match подобрал 4 тура под ваш баланс',
        underBody: '{days} дн. · все в пределах ${balance}',
        genFailTitle: 'Не удалось сгенерировать',
        genFailBody: 'Попробуйте ещё раз через минуту.',
        errorBanner: 'Сейчас не получилось собрать пакеты. Попробуйте ещё раз через минуту.',
        wishAdded: 'Сохранено в вишлист',
        wishRemoved: 'Убрано из вишлиста',
      },
      tagline: {
        bestValue: 'Лучшая цена',
        crowd: 'Выбор путешественников',
        most: 'Максимум впечатлений',
        top: 'Топ-уровень',
      },
      inc: {
        rf: 'Перелёт туда-обратно',
        rfB: 'Перелёт из Бишкека туда-обратно',
        h3: 'Отель 3★',
        h4: 'Отель 4★',
        resort: 'Резорт 4★ с бассейном',
        cityTours: 'Экскурсии по городу с гидом',
        brk: 'Завтраки каждый день',
        halal: 'Гид по халяль-ресторанам',
        half: 'Полупансион',
        sim: 'Местная SIM-карта',
        dayTrips: 'Групповые однодневные поездки',
        transfer: 'Трансферы из аэропорта',
        spa: 'Ваучер в спа',
        exp: 'Подобранные впечатления',
      },
      grid: {
        totalAllIn: 'Итого, всё включено',
        dayTrip: 'дневная',
        tripSuffix: 'поездка',
        left: 'осталось',
        whereGoes1: 'На что уйдут',
        whereGoes2: '',
        reviews: 'отзывов',
        fits: 'Вписывается',
        savesPrefix: 'Экономия',
      },
    },
    footer: {
      brandSub: 'Интеллектуальная платформа',
      desc: 'MAFTRAVEL — туристическая платформа нового поколения, которая упрощает и улучшает планирование путешествий.',
      navigate: 'Навигация',
      platform: 'Платформа',
      company: 'Компания',
      support: 'Поддержка',
      newsletter: 'Оставайтесь в курсе',
      newsletterSub: 'Подпишитесь, чтобы получать лучшие предложения и AI-советы для путешествий.',
      ...
      copy: '© 2026 MAFTRAVEL. Все права защищены.',
    ...
    toolsPage: {
      converter: {
        ...
        sub: 'Переведите бюджет поездки в местную валюту.',
        statusLive: 'живой курс',
        statusLoading: 'загрузка…',
        statusOffline: 'офлайн-курс',
        amount: 'Сумма',
        from: 'Из',
        to: 'В',
        swap: 'Поменять',
      ...
      tip: {
        ...
        sub: 'Рассчитайте чаевые и разделите счёт с компанией.',
        bill: 'Сумма счёта',
        tipLabel: 'Чаевые',
        people: 'Человек',
        tipRow: 'Чаевые',
        totalRow: 'Итого со счётом',
        perHead: 'С человека',
      },
    },
    ...
    tripRec: {
      ...
      heading: 'Куда дальше?',
      subtitle: 'Укажите точку отправления и выберите направление — мы соберём полный AI-план поездки.',
      fromLabel: 'Откуда',
      fromPh: 'Ваш город (например, Ташкент)',
      useLocation: 'Определить моё местоположение',
      locating: 'Определяем…',
      denied: 'Доступ к геолокации закрыт. Введите город вручную.',
      failed: 'Не удалось определить местоположение. Введите город вручную.',
      detected: 'Определено',
      build: 'Собрать AI-план',
    },
    servicesHome: {
      eyebrow: 'Все туристические услуги',
      heading: 'Всё для идеальной поездки',
      subtitle: 'Проверка виз, прогноз цен, eSIM, страховка, трансферы и многое другое — на базе ИИ.',
      cta: 'Все услуги',
    },
    servicesPage: {
      navLabel: 'Услуги',
      seoTitle: 'Туристические услуги — виза, eSIM, страховка и AI-прогнозы цен | MAFTRAVEL',
      seoDesc: 'AI-проверка виз, оптимизатор бюджета, прогнозы цен на авиабилеты и отели, страховка, eSIM, трансферы и залы ожидания — всё в одном месте.',
      hero: {
        badge: 'Умные туристические услуги',
        title1: 'Путешествуйте умнее —',
        title2: 'с AI-сервисами',
        sub: 'От визовых правил до прогноза цен и всего нужного в поездке — в одном месте.',
      },
      aiSection: 'AI-интеллект для путешествий',
      aiSectionSub: 'Бесплатные AI-инструменты для планирования и экономии',
      bookSection: 'Нужное в поездке',
      bookSectionSub: 'Закажите дополнительные услуги — мы всё организуем',
      common: {
        check: 'Проверить',
        analyze: 'Анализ',
        predict: 'Прогноз',
      ...
      visa: {
        title: 'AI-проверка визы',
        desc: 'Узнайте, нужна ли виза, её стоимость и необходимые документы.',
        nationality: 'Ваше гражданство',
        nationalityPh: 'например, Узбекистан',
        destination: 'Направление',
        destinationPh: 'например, ОАЭ',
        statusFree: 'Без визы',
        statusArrival: 'Виза по прилёте',
        statusEvisa: 'Электронная виза',
        statusRequired: 'Нужна виза',
        statusUnknown: 'Проверьте официально',
        stay: 'Макс. пребывание',
        cost: 'Стоимость',
        processing: 'Оформление',
        documents: 'Документы',
      },
      budget: {
        title: 'AI-оптимизатор бюджета',
        desc: 'Посмотрите, на что хватит денег и как их распределить.',
        destination: 'Направление',
        budget: 'Общий бюджет (USD)',
        days: 'Дни',
        travelers: 'Путешественники',
        perDay: 'В день',
        verdictTight: 'Впритык, но реально',
        verdictComfortable: 'Комфортно',
        verdictGenerous: 'С запасом',
        tips: 'Как сэкономить',
      },
      cheapest: {
        title: 'Самый дешёвый месяц',
        desc: 'Найдите лучший месяц по цене и погоде.',
        destination: 'Направление',
      ...
      flightPredict: {
        title: 'Прогноз цен на авиабилеты',
        desc: 'Оцените тарифы: покупать сейчас или подождать.',
        from: 'Откуда',
        to: 'Куда',
        month: 'Месяц (необязательно)',
        window: 'Лучшее окно покупки',
      },
      hotelPredict: {
        title: 'Прогноз цен на отели',
        desc: 'Оцените цену за ночь и лучший район для проживания.',
        city: 'Город',
        tier: 'Уровень отеля',
      ...
      trendRising: 'Цены растут',
      trendFalling: 'Цены снижаются',
      trendStable: 'Цены стабильны',
      insurance: {
        title: 'Страхование путешествий',
        desc: 'Медицина, багаж и отмена поездки. От $1.5/день.',
      },
      esim: {
        title: 'eSIM для путешествий',
        desc: 'Онлайн с момента приземления. Интернет в 190+ странах.',
      },
      transfer: {
        title: 'Трансфер из аэропорта',
        desc: 'Личный автомобиль «от двери до двери». Без торга с такси.',
      },
      lounge: {
        title: 'Зал ожидания в аэропорту',
        desc: 'Отдохните перед рейсом — еда, Wi-Fi и тишина. 1300+ залов.',
      },
    },
    antarctica: {
      hero: {
