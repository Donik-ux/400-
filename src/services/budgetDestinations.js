...
const DESTINATIONS = [
  ...
  { city: 'Bukhara',   country: 'Узбекистан',  flag: '🇺🇿', region: 'Центральная Азия', flight: 125, daily: 35,  tags: ['история', 'культура', 'бюджетно'], blurb: 'Городу больше 2000 лет — живой музей Шёлкового пути под открытым небом.' },
