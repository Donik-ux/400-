            ...
            <Section num="3" title={t('legal.cookies.s3Title')}>
              <div className="space-y-2">
                <div className="flex gap-3 items-start">
                  <span className="mt-0.5 w-2 h-2 rounded-full bg-[#252a31] flex-shrink-0"></span>
                  <p><strong className="text-[#252a31]">{t('legal.cookies.s3aT')}</strong> — {t('legal.cookies.s3aD')}</p>
                </div>
                <div className="flex gap-3 items-start">
                  <span className="mt-0.5 w-2 h-2 rounded-full bg-[#252a31] flex-shrink-0"></span>
                  <p><strong className="text-[#252a31]">{t('legal.cookies.s3bT')}</strong> — {t('legal.cookies.s3bD')}</p>
                </div>
                <div className="flex gap-3 items-start">
                  <span className="mt-0.5 w-2 h-2 rounded-full bg-[#252a31] flex-shrink-0"></span>
                  <p><strong className="text-[#252a31]">{t('legal.cookies.s3cT')}</strong> — {t('legal.cookies.s3cD')}</p>
                </div>
                <div className="flex gap-3 items-start">
                  <span className="mt-0.5 w-2 h-2 rounded-full bg-[#252a31] flex-shrink-0"></span>
                  <p><strong className="text-[#252a31]">{t('legal.cookies.s3dT')}</strong> — {t('legal.cookies.s3dD')}</p>
                </div>
              </div>
            </Section>
