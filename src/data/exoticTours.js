...
export const TOURS = [
  {
    ...
    badgeColor: 'from-[#c26d4a] to-[#2d6a6f]',
  ...
  },
  {
    ...
    badge: '🔥 → ❄️',
    badgeLabel: 'Hot to Cold',
    badgeColor: 'from-[#6b8f5e] to-[#3d6b8a]',
  ...
  },
  {
    ...
    badge: '🔥 → ❄️',
    badgeLabel: 'Hot to Cold',
    badgeColor: 'from-[#c9962f] to-[#2d6a6f]',
  ...
  },
  {
    ...
    badge: '🔥 → ❄️',
    badgeLabel: 'Hot to Cold',
    badgeColor: 'from-[#b5495a] to-[#5c5245]',
  ...
  },
  {
    ...
    badgeColor: 'from-[#7d5a8c] to-[#b56576]',
  ...
  },
  {
    ...
    badgeColor: 'from-[#3d6b8a] to-[#c26d4a]',
  ...
  },
  {
    ...
    badge: '🌍 Cultural Mix',
    badgeLabel: 'Cultural Contrast',
    badgeColor: 'from-[#6b8f5e] to-[#7d5a8c]',
  ...
  },
  {
    ...
    badge: '🔥 → ❄️',
    badgeLabel: 'Hot to Cold',
    badgeColor: 'from-[#c9962f] to-[#3d6b8a]',
  ...
  },
  {
    ...
    badge: '🌍 Cultural Mix',
    badgeLabel: 'Cultural Contrast',
    badgeColor: 'from-[#c9962f] to-[#7d5a8c]',
    title: 'Bukhara Silk Road to Dubai Future',
    tagline: '2,000 years of history to the city of tomorrow',
    from: { city: 'Bukhara', country: 'Uzbekistan', flag: '🇺🇿', temp: '+30°C', icon: '🕌' },
    to:   { city: 'Dubai', country: 'UAE', flag: '🇦🇪', temp: '+40°C', icon: '🏙️' },
    days: 9,
    price: '€1,900',
    rating: 4.9,
    reviews: 54,
    groupSize: '6–12',
    desc: 'Walk lantern-lit lanes of a 2,000-year-old UNESCO Silk Road city — minarets, trading domes and teahouses — then jump twelve centuries forward to Dubai\'s glass skyline. The oldest and newest faces of the East in one trip.',
    highlights: ['Po-i-Kalyan & Ark Fortress', 'Lyab-i Hauz teahouse evening', 'Old City trading domes bazaar', 'Burj Khalifa at sunset', 'Dubai desert safari'],
    image: 'https://images.unsplash.com/photo-1670514535515-e7af911bdadb?auto=format&fit=crop&w=800&q=80',
  },
  {
    id: 10,
    type: 'hot-cold',
    badge: '🔥 → ❄️',
    badgeLabel: 'Hot to Cold',
    badgeColor: 'from-[#c26d4a] to-[#3d6b8a]',
    title: 'Hawaii Beaches to Alaska Glaciers',
    tagline: 'America\'s two most beautiful states, back to back',
    from: { city: 'Maui', country: 'Hawaii, USA', flag: '🇺🇸', temp: '+29°C', icon: '🌺' },
    to:   { city: 'Anchorage', country: 'Alaska, USA', flag: '🇺🇸', temp: '-4°C', icon: '🏔️' },
    days: 12,
    price: '€5,400',
    rating: 4.8,
    reviews: 61,
    groupSize: '6–10',
    desc: 'Surf volcanic-sand beaches and drive the Road to Hana in Hawaii, then fly north to calving glaciers, whales and midnight sun in Alaska. Two US states, two opposite ends of nature\'s spectrum.',
    highlights: ['Maui Road to Hana', 'Haleakalā volcano sunrise', 'Waikiki surf lesson', 'Kenai Fjords glacier cruise', 'Denali wildlife day'],
