...
<style>
  *{box-sizing:border-box}
  body{font-family:-apple-system,'Segoe UI',Roboto,Arial,sans-serif;color:#252a31;margin:0;background:#f5f7f9}
  .wrap{max-width:760px;margin:0 auto;padding:28px}
  .hero{background:linear-gradient(135deg,#001026,#1c2127 55%,#252a31);color:#fff;border-radius:18px;padding:26px 28px;margin-bottom:22px}
  .brand{font-size:11px;letter-spacing:.22em;text-transform:uppercase;color:#009882;font-weight:800}
  ...
  .day{background:#fff;border:1px solid #dfe7ec;border-radius:14px;padding:16px 18px;margin-bottom:14px;page-break-inside:avoid}
  .day h2{font-size:17px;margin:0 0 10px;display:flex;align-items:center;gap:10px}
  .num{display:inline-flex;width:26px;height:26px;border-radius:8px;background:#009882;color:#1c2127;align-items:center;justify-content:center;font-size:13px;font-weight:900}
  table{width:100%;border-collapse:collapse}
  td{padding:6px 8px;font-size:13px;border-bottom:1px solid #e8edf1;vertical-align:top}
  td.t{white-space:nowrap;color:#0172cb;font-weight:700;width:60px}
  td.c{text-align:right;white-space:nowrap;font-weight:700;color:#252a31;width:72px}
  .desc{color:#777;font-size:12px;margin-top:2px}
  .meals,.acc{font-size:12px;color:#555;margin-top:8px}
  .budget .total td{font-weight:900;color:#1c2127;border-top:2px solid #1c2127;border-bottom:0}
  .tips ul{margin:0;padding-left:18px}.tips li{font-size:13px;margin-bottom:5px}
  .foot{margin-top:24px;text-align:center;font-size:11px;color:#697d95}
  ...
  <div class="wrap">
    ...
    <p class="no-print" style="text-align:center;margin-top:18px">
      <button onclick="window.print()" style="background:#009882;border:0;padding:11px 24px;border-radius:10px;font-weight:800;font-size:14px;cursor:pointer;color:#1c2127">Save as PDF</button>
    </p>
  </div>
