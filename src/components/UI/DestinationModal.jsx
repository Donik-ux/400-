              ...
              {[
                ...
                <div key={label} className="bg-white/[0.04] border border-white/[0.06] rounded-xl p-4 hover:bg-white/[0.06] hover:border-white/[0.1] transition-premium">
                  <div className="flex items-center gap-1.5 mb-2">
                    <Icon className="w-3 h-3 text-[#00a58e]/70" />
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {destination.highlights.map(({ icon, title, desc: hDesc }) => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-xl bg-white/[0.06] border border-white/[0.07] flex items-center justify-center text-[18px] shrink-0 transition-premium group-hover:scale-110 group-hover:border-[#00a58e]/30 group-hover:bg-[#00a58e]/[0.08]">
                      {icon}
                    </div>
                    <div>
