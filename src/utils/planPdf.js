...
<style>
  *{box-sizing:border-box}
  ...
  .brand{font-size:11px;letter-spacing:.22em;text-transform:uppercase;color:#cf9c3f;font-weight:800}
  ...
  .num{display:inline-flex;width:26px;height:26px;border-radius:8px;background:#cf9c3f;color:#002250;align-items:center;justify-content:center;font-size:13px;font-weight:900}
  table{width:100%;border-collapse:collapse}
  td{padding:6px 8px;font-size:13px;border-bottom:1px solid #efe6d2;vertical-align:top}
  td.t{white-space:nowrap;color:#2f6395;font-weight:700;width:60px}
  ...
  <div class="wrap">
    ...
    <p class="no-print" style="text-align:center;margin-top:18px">
      <button onclick="window.print()" style="background:#cf9c3f;border:0;padding:11px 24px;border-radius:10px;font-weight:800;font-size:14px;cursor:pointer;color:#002250">Save as PDF</button>
    </p>
  </div>
