  ...
  en: {
    tripPlan: {
      ...
      flights: {
        ...
        stopOne: '1 stop',
        stops: '{count} stops',
        optionsTitle: 'Other flights on these dates',
        optionsNote: 'Same route and days — a different aircraft, airline or number of stops.',
        role: {
          chosen: 'In your plan',
          cheapest: 'Cheapest',
          fastest: 'Quickest',
        ...
        saves: '−{amount}',
        checkDates: 'Cheaper on another day?',
        checkingDates: 'Checking nearby dates…',
        daysEarlier: '{count} days earlier',
        daysLater: '{count} days later',
        datesCheaper: 'Leaving {when} costs {amount} less per person — {price} instead.',
        datesBest: 'Your dates are already the cheapest of the ones we checked.',
        datesFailed: 'Could not price the nearby dates right now.',
  ...
  uz: {
    tripPlan: {
      ...
      flights: {
        ...
        stopOne: '1 ta to‘xtash',
        stops: '{count} ta to‘xtash',
        optionsTitle: 'Shu sanalardagi boshqa parvozlar',
        optionsNote: 'Xuddi shu yo‘nalish va kunlar — samolyot turi, aviakompaniya yoki to‘xtashlar soni boshqacha.',
        role: {
          chosen: 'Rejangizda',
          cheapest: 'Eng arzon',
          fastest: 'Eng tez',
        ...
        saves: '−{amount}',
        checkDates: 'Boshqa kuni arzonroqmi?',
        checkingDates: 'Yaqin sanalar tekshirilmoqda…',
        daysEarlier: '{count} kun oldin',
        daysLater: '{count} kun keyin',
        datesCheaper: '{when} uchsangiz, har bir kishi uchun {amount} arzonroq — {price} bo‘ladi.',
        datesBest: 'Sizning sanangiz tekshirilganlar ichida eng arzoni.',
        datesFailed: 'Hozir yaqin sanalarning narxini aniqlab bo‘lmadi.',
