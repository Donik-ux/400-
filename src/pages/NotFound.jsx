  ...
  return (
    <div className="relative min-h-[70vh] flex items-center justify-center px-4 py-16 bg-[#f5f7f9] overflow-hidden">
      ...
      <div className="relative max-w-xl w-full bg-white border border-[#dfe7ec] rounded-2xl shadow-lift p-10 text-center page-fade">
        <div className="animate-float w-20 h-20 rounded-2xl bg-[#252a31] text-[#00a58e] flex items-center justify-center mx-auto mb-5 rotate-3 shadow-float">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <button onClick={() => navigate('/')}
            className="px-5 py-3 rounded-xl border border-[#dfe7ec] hover:border-[#0172cb] hover:bg-[#e8f4fd] text-[13px] font-black text-[#252a31] transition active:scale-95 flex items-center justify-center gap-2">
        ...
        <div className="flex justify-center gap-5 text-[#4a5867]">
          ...
          <button onClick={() => navigate('/exotic-tours')} className="flex items-center gap-1.5 text-[12px] font-bold hover:text-[#0172cb] transition">
            <Flame className="w-3.5 h-3.5" /> {t('nav.exotic')}
          </button>
        </div>
      </div>
    </div>
