      ...
      <div className="relative p-4 md:p-5">
        <div className="flex items-start gap-3 mb-3">
          ...
          <div className="min-w-0">
            <p className={`text-[14px] md:text-[15px] font-black leading-tight ${isTiny ? 'text-[#6e2a1e]' : 'text-[#7c4a00]'}`}>
              {isTiny
        ...
        <div className={`rounded-xl border backdrop-blur-sm ${isTiny ? 'border-[#f3ded8] bg-white/90' : 'border-[#febb02]/30 bg-white/85'} p-3 md:p-4 shadow-soft`}>
          ...
          <p className={`text-[11px] mt-3 leading-snug ${isTiny ? 'text-danger' : 'text-[#7c4a00]'} font-semibold flex items-start gap-1.5`}>
